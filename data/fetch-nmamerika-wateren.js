#!/usr/bin/env node
// Issue #51 (set 8.3 NMA): wateren via Overpass.
//   Mississippi  Q1497   → main_stream LineString (bron MN → delta LA)
//   Rio Grande   Q160636 → main_stream LineString (Colorado → Mexicaanse Golf)
//   Panamakanaal Q7350   → LineString (chain alle ways)
// Caribische Zee = fuzzy ellips (geen fetch, in cities.js).
//
// Gebruikt meerdere mirrors omdat overpass-api.de vaak "too busy" is
...
const QUERIES = [
  { out: 'mississippi.json',  q: 'relation["wikidata"="Q1497"]["waterway"="river"];out geom qt;' },
  { out: 'rio-grande.json',   q: 'relation["wikidata"="Q160636"]["waterway"="river"];out geom qt;' },
  { out: 'panamakanaal.json', q: 'relation["wikidata"="Q7350"];out geom qt;' },
];
