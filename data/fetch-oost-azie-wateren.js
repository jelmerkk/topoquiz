#!/usr/bin/env node
// Issue #54 (set 8.6 Oost-Azië): wateren via Overpass.
//   Huang He      Q7355 → main_stream LineString (Tibetaans plateau → Bohai-zee)
//   Chang Jiang   Q5413 → main_stream LineString (Tibetaans plateau → Shanghai)
//
// Overige wateren zijn fuzzy ellipsen (Zuid-Chinese Zee, Grote Oceaan).
...
const QUERIES = [
  { out: 'huang-he.json',    q: 'relation["wikidata"="Q7355"]["waterway"="river"];out geom qt;' },
  { out: 'chang-jiang.json', q: 'relation["wikidata"="Q5413"]["waterway"="river"];out geom qt;' },
];
