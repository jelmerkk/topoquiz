#!/usr/bin/env node
// Issue #52 (set 8.4 Midden-Oosten): wateren via Overpass.
//   Eufraat  Q34589 → main_stream LineString (Turkije → Shatt al-Arab)
//
// Overige wateren in set 8.4 zijn fuzzy ellipsen (Zwarte Zee, Perzische
// Golf, Rode Zee, Kaspische Zee, Middellandse Zee, Indische Oceaan) of
// hergebruiken een bestaand feature (Suezkanaal ook in set 82).
...
const QUERIES = [
  { out: 'eufraat.json', q: 'relation["wikidata"="Q34589"]["waterway"="river"];out geom qt;' },
];
